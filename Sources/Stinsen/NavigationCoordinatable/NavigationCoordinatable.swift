...
extension NavigationCoordinatable {
    ...
    public func dismissChild<T: Coordinatable>(coordinator: T, action: (() -> Void)? = nil) {
        guard
            let value = stack.value.firstIndex(where: { item in
    ...
    public func dismissCoordinator(_ action: (() -> Void)? = nil) {
    ...
    public func popLast(_ action: (() -> Void)? = nil) {
    ...
    @discardableResult public func popToRoot(_ action: (() -> Void)? = nil) -> Self {
        self.popTo(-1, action)
        return self
    }

    @discardableResult public func route<Input, Output: Coordinatable>(
        to route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input,
    ...
    @discardableResult public func route<Output: Coordinatable>(
        to route: KeyPath<Self, Transition<Self, Presentation, Void, Output>>,
        onDismiss: @escaping () -> Void
    ) -> Output {
        stack.dismissalAction[stack.value.count - 1] = onDismiss
    ...
    @discardableResult public func route<Input, Output: View>(
        to route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input,
        onDismiss: @escaping () -> Void
    ) -> Self {
    ...
    @discardableResult public func route<Output: View>(
        to route: KeyPath<Self, Transition<Self, Presentation, Void, Output>>,
        onDismiss: @escaping () -> Void
    ) -> Self {
        stack.dismissalAction[stack.value.count - 1] = onDismiss
    ...
    @discardableResult private func _focusFirst<Input, Output: Coordinatable>(
        ...
        guard
            let value = stack.value.enumerated().first(where: { item in
    ...
    @discardableResult public func focusFirst<Input, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input,
        comparator: @escaping (Input, Input) -> Bool
    ) throws -> Output {
    ...
    @discardableResult public func focusFirst<Input, Output: View>(
        _ route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input,
        comparator: @escaping (Input, Input) -> Bool
    ) throws -> Self {
    ...
    @discardableResult public func focusFirst<Input: Equatable, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input
    ) throws -> Output {
    ...
    @discardableResult public func focusFirst<Input: Equatable, Output: View>(
        _ route: KeyPath<Self, Transition<Self, Presentation, Input, Output>>,
        _ input: Input
    ) throws -> Self {
        try self._focusFirst(route, (value: input, comparator: { $0 == $1 }))
    ...
    @discardableResult public func root<Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Void, Output>>
    ) -> Output {
        self._root(route, inputItem: nil)
    }

    @discardableResult public func root<Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Void, Output>>
    ) -> Self {
        self._root(route, inputItem: nil)
    }

    @discardableResult public func root<Input, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>
    ) -> Output {
        self._root(route, inputItem: nil)
    }

    @discardableResult public func root<Input, Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>
    ) -> Self {
        self._root(route, inputItem: nil)
    }
    ...
    @discardableResult public func root<Input: Equatable, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input
    ) -> Output {
    ...
    @discardableResult public func root<Input: Equatable, Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input
    ) -> Self {
        self._root(route, inputItem: (input, { $0 == $1 }))
    ...
    @discardableResult public func isRoot<Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Void, Output>>
    ) -> Bool {
        return self._isRoot(route, inputItem: nil)
    }

    @discardableResult public func isRoot<Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Void, Output>>
    ) -> Bool {
        return self._isRoot(route, inputItem: nil)
    }

    @discardableResult public func isRoot<Input, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>
    ) -> Bool {
        return self._isRoot(route, inputItem: nil)
    }

    @discardableResult public func isRoot<Input, Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>
    ) -> Bool {
        return self._isRoot(route, inputItem: nil)
    }

    @discardableResult public func isRoot<Input: Equatable, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input
    ) -> Bool {
    ...
    public func isRoot<Input: Equatable, Output: View>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input
    ) -> Bool {
        return self._isRoot(route, inputItem: (input: input, comparator: { $0 == $1 }))
    ...
    public func isRoot<Input: Equatable, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input,
        comparator: @escaping (Input, Input) -> Bool
    ) -> Bool {
    ...
    @discardableResult public func hasRoot<Input, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>
    ) -> Output? {
        return self._hasRoot(route, inputItem: nil)
    }

    @discardableResult public func hasRoot<Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Void, Output>>
    ) -> Output? {
        return self._hasRoot(route, inputItem: nil)
    }

    @discardableResult public func hasRoot<Input: Equatable, Output: Coordinatable>(
        _ route: KeyPath<Self, Transition<Self, RootSwitch, Input, Output>>,
        _ input: Input
    ) -> Output? {
